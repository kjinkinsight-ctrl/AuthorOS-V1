    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Settings stays pinned below the scrolling groups. It used to be the
          // list's last child, which a lazy ListView stops building once enough
          // Studios push it past the fold - on a short window it silently
          // became unreachable without scrolling. Anchoring it here keeps it
          // present no matter how many Studios the groups grow to hold.
          Padding(
            padding: const EdgeInsets.fromLTRB(12, 0, 12, 12),
