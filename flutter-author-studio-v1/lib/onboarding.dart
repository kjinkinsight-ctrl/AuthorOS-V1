...
/// Project seed data moved to `lib/core/starter_project.dart` so the
/// persistence layer can store a project without importing Flutter.
/// Re-exported here so every existing import of this library keeps working.
export 'core/starter_project.dart';
